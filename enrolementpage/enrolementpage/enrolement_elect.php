...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profilePicture"]["tmp_name"], $target_file)) {
            ...
            try {
                $stmt = $bdd->prepare("INSERT INTO enregistrement (firstName, lastName, postnom, Adress, uniqueCode, profilePicture) VALUES (:firstName, :lastName, :postnom, :Adress, :uniqueCode, :profilePicture)");
